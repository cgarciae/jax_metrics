...
Tensor = jnp.ndarray
tensor = jnp.array
from metrix.metrics.tm_port.functional.classification.stat_scores import (
    _stat_scores_compute,
    _stat_scores_update,
)
from metrix.metrics.tm_port.metric import Metric
from metrix.metrics.tm_port.utilities.enums import AverageMethod, MDMCAverageMethod
